      ...
      <div className="flex flex-col text-2xl md:text-7xl gap-6">
        <div className="group lg:flex lg:flex-row">
          <Link
            ...
            target="_blank"
            className="transition ease-in-out delay-150 hover:text-orange dark:text-white group-hover:dark:text-orange"
          >
            nioosha shams
          </Link>
        ...
        <div className="group lg:flex lg:flex-row">
          <Link
            ...
            target="_blank"
            className="hover:text-orange dark:text-white group-hover:dark:text-orange"
          >
            the movie database
          </Link>
          <div className="md:hidden group-hover:block lg:ml-8">
